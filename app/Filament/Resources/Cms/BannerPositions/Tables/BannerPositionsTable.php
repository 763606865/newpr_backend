...
namespace App\Filament\Resources\Cms\BannerPositions\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('name')->label('版位名称')->searchable(),
                TextColumn::make('code')->label('版位编码')->searchable(),
                TextColumn::make('width')->label('宽'),
                TextColumn::make('height')->label('高'),
