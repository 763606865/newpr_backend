...
class SApiResumeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'political_status' => $this->resource->political_status,
            'native_place' => $this->resource->native_place,
            'current_identity' => $this->resource->current_identity?->value ?? $this->resource->current_identity,
            'work_start_date' => $this->resource->work_start_date,
            'work_years' => $this->resource->work_years,
            'highest_education_level' => $this->resource->highest_education_level?->value ?? $this->resource->highest_education_level,
            ...
            'expected_salary_unit' => $this->resource->expected_salary_unit?->value ?? $this->resource->expected_salary_unit,
