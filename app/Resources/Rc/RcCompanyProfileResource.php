...
class RcCompanyProfileResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'rest_type' => $this->resource->rest_type?->value,
            'rest_type_label' => $this->resource->rest_type?->getLabel(),
            'salary_pay_day' => $this->resource->salary_pay_day,
            'has_overtime_subsidy' => $this->resource->has_overtime_subsidy,
