...
class RcResumePreviewResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'is_promoted' => (bool) ($this->resource->getAttribute('is_promoted') ?? false),
            'promotion_id' => $this->resource->getAttribute('promotion_id'),
            'promotion_label' => $this->resource->getAttribute('is_promoted') ? '推广' : null,
